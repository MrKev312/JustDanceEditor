...
{
    public required string VideoOutputFolder { get; init; }
...
public static class VideoConverter
{
    public static Task ConvertVideoAsync(
        ...
        Task.Run(() => ConvertVideo(songData, fileSystem, options));
        ...
        VideoConversionOptions options)
    {
        ...
        try
        {
            UbiArtVideoConversionRequest conversionRequest = BuildRequest(songData, fileSystem, options);
            UbiArtVideoConverter.ConvertVideo(conversionRequest);
        }
        catch (Exception e)
        {
    ...
    private static UbiArtVideoConversionRequest BuildRequest(
        ...
        VideoConversionOptions options)
    {
        string videoOutputFolder = options.VideoOutputFolder;
