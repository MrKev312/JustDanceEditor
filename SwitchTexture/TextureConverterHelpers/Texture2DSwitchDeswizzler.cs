...
public class Texture2DSwitchDeswizzler
{
	...
	*/
    ...
    {
        Image<Rgba32> dstImage = new(srcImage.Width, srcImage.Height);
    ...
    internal static Size TextureFormatToBlockSize(TextureFormat m_TextureFormat)
    {
        ...
        {
            TextureFormat.Alpha8 => new Size(16, 1),// 1 byte per pixel
            TextureFormat.ARGB4444 => new Size(8, 1),// 2 bytes per pixel
            TextureFormat.RGBA32 => new Size(4, 1),// 4 bytes per pixel
            TextureFormat.ARGB32 => new Size(4, 1),// 4 bytes per pixel
            TextureFormat.ARGBFloat => new Size(1, 1),// 16 bytes per pixel (?)
            TextureFormat.RGB565 => new Size(8, 1),// 2 bytes per pixel
            TextureFormat.R16 => new Size(8, 1),// 2 bytes per pixel
            TextureFormat.DXT1 => new Size(8, 4),// 8 bytes per 4x4=16 pixels
            TextureFormat.DXT5 => new Size(4, 4),// 16 bytes per 4x4=16 pixels
            TextureFormat.RGBA4444 => new Size(8, 1),// 2 bytes per pixel
            TextureFormat.BGRA32 => new Size(4, 1),// 4 bytes per pixel
            TextureFormat.BC6H => new Size(4, 4),// 16 bytes per 4x4=16 pixels
            TextureFormat.BC7 => new Size(4, 4),// 16 bytes per 4x4=16 pixels
            TextureFormat.BC4 => new Size(8, 4),// 8 bytes per 4x4=16 pixels
            TextureFormat.BC5 => new Size(4, 4),// 16 bytes per 4x4=16 pixels
            TextureFormat.ASTC_RGB_4x4 => new Size(4, 4),// 16 bytes per 4x4=16 pixels
            TextureFormat.ASTC_RGB_5x5 => new Size(5, 5),// 16 bytes per 5x5=25 pixels
            TextureFormat.ASTC_RGB_6x6 => new Size(6, 6),// 16 bytes per 6x6=36 pixels
            TextureFormat.ASTC_RGB_8x8 => new Size(8, 8),// 16 bytes per 8x8=64 pixels
            TextureFormat.ASTC_RGB_10x10 => new Size(10, 10),// 16 bytes per 10x10=100 pixels
            TextureFormat.ASTC_RGB_12x12 => new Size(12, 12),// 16 bytes per 12x12=144 pixels
            TextureFormat.ASTC_RGBA_4x4 => new Size(4, 4),// 16 bytes per 4x4=16 pixels
            TextureFormat.ASTC_RGBA_5x5 => new Size(5, 5),// 16 bytes per 5x5=25 pixels
            TextureFormat.ASTC_RGBA_6x6 => new Size(6, 6),// 16 bytes per 6x6=36 pixels
            TextureFormat.ASTC_RGBA_8x8 => new Size(8, 8),// 16 bytes per 8x8=64 pixels
            TextureFormat.ASTC_RGBA_10x10 => new Size(10, 10),// 16 bytes per 10x10=100 pixels
            TextureFormat.ASTC_RGBA_12x12 => new Size(12, 12),// 16 bytes per 12x12=144 pixels
            TextureFormat.RG16 => new Size(8, 1),// 2 bytes per pixel
            TextureFormat.R8 => new Size(16, 1),// 1 byte per pixel
