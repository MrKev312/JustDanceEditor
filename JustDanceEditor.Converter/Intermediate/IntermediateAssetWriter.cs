...
internal static class IntermediateAssetWriter
{
    ...
    private static void CopyAssetsToPackage(ConversionContext context, IntermediateAssetCatalog catalog, string packageRoot, AssetStagingArea staging)
    {
        ...
        AttachAudioAssets(context, catalog, dirs, staging);
        AttachVideoAssets(context, catalog, dirs, staging);
    ...
    private static void AttachAudioAssets(ConversionContext context, IntermediateAssetCatalog catalog, AssetDirectories dirs, AssetStagingArea staging)
    {
    ...
    private static void AttachVideoAssets(ConversionContext context, IntermediateAssetCatalog catalog, AssetDirectories dirs, AssetStagingArea staging)
    {
